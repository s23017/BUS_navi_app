...
export async function loadStops() {
  ...
  try {
    ...
    if (nahaData && nahaData.stops) allStops.push(...nahaData.stops);
  } catch (e) {}
...
export async function loadStopTimes() {
  ...
  try {
    const nahaData = await loadNahaData();
    if (nahaData && nahaData.stopTimes) allStopTimes.push(...nahaData.stopTimes);
  } catch (e) {}
...
export async function loadTrips() {
  ...
  try {
    const nahaData = await loadNahaData();
    if (nahaData && nahaData.trips) allTrips.push(...nahaData.trips);
  } catch (e) {}
  tripsCache = allTrips;
  return allTrips;
}
...
export async function loadRoutes() {
  ...
  try {
    const nahaData = await loadNahaData();
    if (nahaData && nahaData.routes) allRoutes.push(...nahaData.routes);
  } catch (e) {}
